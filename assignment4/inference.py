...
class ExactInference(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        # print emissionModel
        # {0: 0, 1: 0.8350785340314136, 2: 0.08376963350785341, 3: 0.041884816753926704, 4: 0.020942408376963352, 5: 0.010471204188481676, 6: 0.005235602094240838, 7: 0.002617801047120419}

        # [(1, 4), (2, 4), (3, 4), (5, 2), (5, 4), (7, 4), (8, 4), (9, 4)]
        # print self.legalPositions

        # print self.beliefs
        # {(5, 4): 0.14285714285714285, (1, 4): 0.14285714285714285, (7, 4): 0.14285714285714285, (9, 4): 0.14285714285714285, (3, 4): 0.14285714285714285, (2, 4): 0.14285714285714285, (8, 4): 0.14285714285714285}

        # print busters.getObservationDistribution(5)
        # {1: 0.03926701570680629, 2: 0.041884816753926704, 3: 0.08376963350785341, 4: 0.16753926701570682, 5: 0.33507853403141363, 6: 0.16753926701570682, 7: 0.08376963350785341, 8: 0.041884816753926704, 9: 0.020942408376963352, 10: 0.010471204188481676, 11: 0.005235602094240838, 12: 0.002617801047120419}
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for p in self.legalPositions:
            for pos, prob in self.getPositionDistribution(self.setGhostPosition(gameState, p)).items():
                newPosDist[pos] += prob*self.beliefs[p]
...
class ParticleFilter(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        "*** YOUR CODE HERE ***"
        # util.raiseNotDefined()
        # oldPos =self.getBeliefDistribution()
        newPosDist = util.Counter()
        t = []
...
class JointParticleFilter:
    ...
    def initializeParticles(self):
        ...
        while i < self.numParticles:
            # for p in self.legalPositions:
            # p = itertools.permutations(self.legalPositions,self.numGhosts)
